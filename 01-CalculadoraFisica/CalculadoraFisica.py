...
if OpcaoMenu=="1":
	...
	TipoConversaoTemperatura=input("")
	if TipoConversaoTemperatura=="1":
	...
	elif TipoConversaoTemperatura=="2":
		print('\nTemperatura é uma grandeza microscopica, que é a média das velocidades das moleculas ou atomos de determinado corpo\n')
	...
	elif TipoConversaoTemperatura=="3":
		print('\nTemperatura é uma grandeza microscopica, que é a média das velocidades das moleculas ou atomos de determinado corpo\n')
	...
	elif TipoConversaoTemperatura=="4":
		print('\nTemperatura é uma grandeza microscopica, que é a média das velocidades das moleculas ou atomos de determinado corpo\n')
	...
	elif TipoConversaoTemperatura=="5":
		print('\nTemperatura é uma grandeza microscopica, que é a média das velocidades das moleculas ou atomos de determinado corpo\n')
	...
	elif TipoConversaoTemperatura=="6":
		print('\nTemperatura é uma grandeza microscopica, que é a média das velocidades das moleculas ou atomos de determinado corpo\n')
...
#PARTE-2-3-4 (CALOR SENSIVEL)	
	...
	CalorSensivelIcognita=input()
	if CalorSensivelIcognita=="Q":
	...
	elif CalorSensivelIcognita=="Delta0":
...
#PARTE-2-3-4 (CALOR SENSIVEL + LATENTE)
	...
	CalorSensivelLatenteIcognita=input()
